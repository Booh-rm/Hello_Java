...
public class ctlCustomers {
    ...
    public LinkedList<clsChartPetsCustomer> PetCustomer(){
        return modelCustomer.ChartPetsCustomer();
    }
    
    //--------------------------------------------------------------------------
    
    public LinkedList<clsClientsWithTheirPets> ClientsWithTheirPets(){
        return modelCustomer.clientsWithTheirPetsList();
    }
